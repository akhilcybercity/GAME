      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
          <div>
            ...
            <p className="text-gray-400 text-sm mb-6">
              Identifying and nurturing the next generation of game development talent through structured selection and mentorship.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#framework" className="text-gray-400 hover:text-white transition-colors">Selection Framework</a>
              </li>
              <li>
                <a href="#evaluation" className="text-gray-400 hover:text-white transition-colors">Evaluation Process</a>
              </li>
              <li>
                <a href="#roadmap" className="text-gray-400 hover:text-white transition-colors">Implementation Roadmap</a>
              </li>
              <li>
                <a href="#mentorship" className="text-gray-400 hover:text-white transition-colors">Mentorship & Training</a>
              </li>
              <li>
                <a href="#apply" className="text-gray-400 hover:text-white transition-colors">Application Portal</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">Program Guide</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">emailstoakhilkumarkm@gmil.com</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-gray-400">+91 7025387610</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-400">Ernakulam <br />Kerala, 683565</span>
              </li>
            </ul>
            ...
            <div className="mt-8">
              ...
              <div className="flex">
                <input
                  ...
                  className="px-4 py-2 rounded-l-lg bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm flex-grow"
                />
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © {currentYear} GameTalent. All rights reserved.
          </p>
